...
if !exists("g:Perl_NoKeyMappings") || ( exists("g:Perl_NoKeyMappings") && g:Perl_NoKeyMappings!=1 )
	...
	nnoremap    <buffer>  <silent>  <Leader>cb    <Esc><Esc>:s/^/#/<CR><Esc>:nohlsearch<CR>j
	vnoremap    <buffer>  <silent>  <Leader>cb    <Esc><Esc>:'<,'>s/^/#/<CR><Esc>:nohlsearch<CR>j
	nnoremap    <buffer>  <silent>  <Leader>cn    <Esc><Esc>:s/^#//<CR><Esc>:nohlsearch<CR>j
	vnoremap    <buffer>  <silent>  <Leader>cn    <Esc><Esc>:'<,'>s/^#//<CR><Esc>:nohlsearch<CR>j
