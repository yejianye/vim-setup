...
if exists("b:did_pydoc_ftplugin")
  finish
endif
let b:did_pydoc_ftplugin = 1
...
"mappings
map <buffer> <leader>rp :call ShowPyDoc('<C-R><C-W>', 1)<CR> 
map <buffer> <leader>rP :call ShowPyDoc('<C-R><C-A>', 1)<CR> 
"commands
